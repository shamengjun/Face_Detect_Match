...
应用程序向导已为您创建了此 facedetection 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。
...
facedetection.h
    这是应用程序的主头文件。
    其中包括其他项目特定的标头（包括 Resource.h），并声明 CfacedetectionApp 应用程序类。

facedetection.cpp
    这是包含应用程序类 CfacedetectionApp 的主应用程序源文件。
...
res\facedetection.ico
    这是用作应用程序图标的图标文件。此图标包括在主资源文件 facedetection.rc 中。
...
facedetectionDlg.h、facedetectionDlg.cpp - 对话框
    这些文件包含 CfacedetectionDlg 类。此类定义应用程序的主对话框的行为。对话框模板包含在 facedetection.rc 中，该文件可以在 Microsoft Visual C++ 中编辑。
